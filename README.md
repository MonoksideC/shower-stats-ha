...
## Hardware Overview
This build used a thermostatic shower valve feeding **three outputs** (body jets, rainfall head, hand sprayer). Because of the multi‑output manifold, the temp sensor is **not inline**.  It’s attached to the brass manifold with thermal paste and a pipe‑friendly clamp. Delay to track water temp is minimal once water is flowing.
